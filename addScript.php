...
try
{
	$url = "/admin/script_tags.json?src=https://revise-app.herokuapp.com/addRevise.js?access_token=$access_token";
	$js_file = "https://revise-app.herokuapp.com/addRevise.js?access_token=$access_token";
