...
try
{
	$url = "/admin/script_tags.json?src=https://reserv-app.herokuapp.com/addRevise.js?access_token=$access_token";
	$js_file = "https://reserv-app.herokuapp.com/addRevise.js?access_token=$access_token";
